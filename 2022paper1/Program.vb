...
Module Module1
    ...
    Class TrapCard
        ...
        Public Sub New(ByVal CardNo As Integer)
            ...
            CardNumber = CardNo
        End Sub
        Public Overrides Sub Process(Deck As CardCollection, Discard As CardCollection, Hand As CardCollection, Sequence As CardCollection, CurrentLock As Lock, Choice As String, CardChoice As Integer)
            Dim something As Boolean
            'checks I don't remember
            If something Then
                MyBase.Process(Deck, Discard, Hand, Sequence, CurrentLock, Choice, CardChoice)
            Else
                'do trap stuff
            End If
        End Sub
